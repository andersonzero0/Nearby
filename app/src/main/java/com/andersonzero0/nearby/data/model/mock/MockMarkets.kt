...
val mockMarkets: List<Market> = listOf(
    Market(
        ...
        coupons = 10,
//        rules = listOf(
//            Rule(id = "1", description = "Válido para todos os dias da semana", marketId = "012576ea-4441-4b8a-89e5-d5f32104c7c4"),
//            Rule(id = "2", description = "Válido para todos os horários", marketId = "012576ea-4441-4b8a-89e5-d5f32104c7c4"),
//            Rule(id = "3", description = "Válido para todos os pratos do cardápio", marketId = "012576ea-4441-4b8a-89e5-d5f32104c7c4")
//        ),
