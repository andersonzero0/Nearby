package com.andersonzero0.nearby.ui.component.category
...
import com.andersonzero0.nearby.ui.theme.Gray300
...
fun NearbyCategoryFilterChip(
    ...
    FilterChip(modifier = modifier
        ...
        label = {
            Text(
                text = category.name,
                style = Typography.bodyMedium, color = if (isSelected) Color.White else Gray400
            )
        })
}
...
@Preview
@Composable
private fun NearbyCategoryFilterChipNotSelectPreview() {
    NearbyCategoryFilterChip(
        category = Category(
            id = "1",
            name = "Alimentação"
